...
Task::Kensho::DBDev - A Glimpse at an Enlightened Perl (DBDev)

=head1 VERSION

This document describes Task::Kensho::DBDev version 0.27
...
C<bug-task-kensho-dbdev@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
