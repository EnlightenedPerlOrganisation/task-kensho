...
Task::Kensho::CLI - A Glimpse at an Enlightened Perl (CLI)

=head1 VERSION

This document describes Task::Kensho::CLI version 0.27
...
C<bug-task-kensho-cli@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
