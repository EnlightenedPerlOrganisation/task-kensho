...
Task::Kensho::WebDev - A Glimpse at an Enlightened Perl (WebDev)

=head1 VERSION

This document describes Task::Kensho::WebDev version 0.27
...
C<bug-task-kensho-webdev@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
