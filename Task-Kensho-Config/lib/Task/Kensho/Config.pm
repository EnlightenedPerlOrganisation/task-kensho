...
Task::Kensho::Config - A Glimpse at an Enlightened Perl (Config)

=head1 VERSION

This document describes Task::Kensho::Config version 0.28
...
C<bug-task-kensho-config@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
