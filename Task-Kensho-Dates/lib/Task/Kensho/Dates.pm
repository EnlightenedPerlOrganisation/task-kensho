...
Task::Kensho::Dates - A Glimpse at an Enlightened Perl (Dates)

=head1 VERSION

This document describes Task::Kensho::Dates version 0.27
...
C<bug-task-kensho-dates@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
