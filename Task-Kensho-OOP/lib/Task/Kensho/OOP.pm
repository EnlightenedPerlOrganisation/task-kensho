...
Task::Kensho::OOP - A Glimpse at an Enlightened Perl (OOP)

=head1 VERSION

This document describes Task::Kensho::OOP version 0.28
...
C<bug-task-kensho-oop@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
