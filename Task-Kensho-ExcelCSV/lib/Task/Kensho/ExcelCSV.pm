...
Task::Kensho::ExcelCSV - A Glimpse at an Enlightened Perl (ExcelCSV)

=head1 VERSION

This document describes Task::Kensho::ExcelCSV version 0.27
...
C<bug-task-kensho-excelcsv@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
