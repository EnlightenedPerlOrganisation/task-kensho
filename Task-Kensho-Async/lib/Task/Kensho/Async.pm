...
Task::Kensho::Async - A Glimpse at an Enlightened Perl (Async)

=head1 VERSION

This document describes Task::Kensho::Async version 0.28
...
C<bug-task-kensho-async@rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org>.
